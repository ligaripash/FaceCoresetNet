...
if __name__ == '__main__':
    ...
    #feature, norm, core_template = model(torch.randn(1,2,3,112,112))

    test_image_path = 'face_alignment/high_quality_low_diversity'
    template = []
    ...
    unnorm_embeddings, FPS_sample = model(template_tensor)
    pass
