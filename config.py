...
def get_args():
    ...
    parent_parser.add_argument('--accelerator', type=str, default='gpu')
    parent_parser.add_argument('--devices', type=int, default=1, help='how many gpus')
    parent_parser.add_argument('--strategy', type=str, default='ddp')
    ...
    parent_parser.add_argument('--gamma_lr', help='gamma learning rate', default=1e-3, type=float)
    ...
    parent_parser.add_argument('--gradient_clip_val', default=1.0, type=float)

    parent_parser.add_argument('--check_val_every_n_epoch', default=1, type=int)

    parent_parser.add_argument('--coreset_size', default=5, type=int)
